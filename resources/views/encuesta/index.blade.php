    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="" class="flex mr-auto">
                <img alt="Midone - HTML Admin Template" class="w-12" src="/dist/images/logo-mybrand.svg">
            </a>
    ...
    <div
        ...
        <div class="h-full flex items-center">
            ...
            <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
                <img alt="Midone - HTML Admin Template" class="logo__image w-20" src="/dist/images/logo-mybrand.svg">
            </a>
            <!-- END: Logo -->
            ...
            <div class="content">
                <div class="intro-y flex flex-col sm:flex-row items-center">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <a class="btn btn-primary shadow-md mr-2" href="{{ route('encuestas.create') }}">Agregar</a>
                        <div class="dropdown ml-auto sm:ml-0">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="{{ route('encuestas.create') }}" class="dropdown-item"> <i data-lucide="encuestas" class="w-14 h-14 mr-2"></i> Agregar Encuesta </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div class="overflow-x-auto">
                            <table class="table mt-5">
                                ...
                                <tbody>
                                    @php
                                        $i = ($encuestas->currentPage() - 1) * $encuestas->perPage() + 1;
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-3" href="{{ route('encuestas.show', $encuesta->id) }}">
                                                    <i data-lucide="eye" class="w-4 h-4 mr-1"></i>
                                                </a>
                                                <form action="{{ route('encuestas.destroy', $encuesta->id) }}" method="POST" class="formEliminar">
                                                    @csrf
                                                    @method('DELETE')
